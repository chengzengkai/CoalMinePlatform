...
UParallelVisualizationComponent::UParallelVisualizationComponent()
{
...
void UParallelVisualizationComponent::BeginPlay()
{
	Super::BeginPlay();
}

FPrimitiveSceneProxy* UParallelVisualizationComponent::CreateSceneProxy()
{
	...
	public:
		...
		FDrawTaskSceneProxy(const UParallelVisualizationComponent* InComponent)
...
FBoxSphereBounds UParallelVisualizationComponent::CalcBounds(const FTransform& LocalToWorld) const
{
...
TArray<ACoalMineTaskBase*> UParallelVisualizationComponent::GetOwnerSubTasks() const
{
